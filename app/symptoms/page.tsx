                ...
                <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <div className="rounded-xl border border-neutral-200/50 bg-white/60 p-6 backdrop-blur dark:border-neutral-800/50 dark:bg-neutral-900/60 sm:p-8">
                        ...
                        <form className="grid gap-5">
                            ...
                            <button
                                type="button"
                                className="mt-2 w-full rounded-lg bg-blue-600 px-6 py-3 font-medium text-white transition hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600"
                            >
                                Check probable diagnosis
                            </button>
                        </form>
                    </div>
